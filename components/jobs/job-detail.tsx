...
const PHASE_BADGE_TONE: Record<JobPhase, string> = {
  ...
  materials_arrived: "bg-violet-500/15 text-violet-300 border-violet-400/30",
  demo: "bg-rose-500/15 text-rose-300 border-rose-400/30",
  construction: "bg-amber-500/15 text-amber-300 border-amber-400/30",
  finishing: "bg-orange-500/15 text-orange-300 border-orange-400/30",
